...
// Group 9 PIE Vectors
      ...
      CAN_receive_isr,   // 9.5 eCAN-A
      CAN_tx_isr,   // 9.6 eCAN-A
      rsvd_ISR,        // 9.7
      rsvd_ISR,        // 9.8
...
void InitPieVectTable(void)
{
	...
	PieCtrlRegs.PIEIER1.bit.INTx7 = 1;	// Enable INT 1.7 in the PIE   IER |= M_INT7; // Enable CPU Interrupt 0
	PieCtrlRegs.PIEIER9.bit.INTx5 = 1;  //CAN mailbox interrput 9.5 eCAN-A
	PieCtrlRegs.PIEIER9.bit.INTx6 = 1;  //CAN mailbox interrput 9.6 eCAN-A
